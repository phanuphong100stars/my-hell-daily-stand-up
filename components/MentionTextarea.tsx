...
export default function MentionTextarea({ value, onValueChange, users, placeholder, className }: Props) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    ...
    if (e.key === "Tab") { e.preventDefault(); commit(suggestions[selected].nickname); }
